<%-- 
    ...
    Created on : 2020/4/6, 下午 07:49:50
    Author     : teacher
--%>
...
<html>
    ...
    <body>
        ...
        <c:set var="testData" value="Hello"/>
        <c:set var="testAge" value="18"/>
 
<sql:update dataSource="${sample}" var="count">
        update  Employees set  lastname ='${testData}' , age=${testAge}  where ID= ${empId} 
</sql:update>
